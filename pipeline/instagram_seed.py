...
ID_LIB = {
    "lp-warocqueanum.png": ["velvet-anthurium", "rarest-jungle", "leaf-texture", "app-identify"],
    "lp-ace-of-spades.png": ["velvet-anthurium", "rarest-jungle", "leaf-texture", "app-identify"],
    "lp-crystallinum.png": ["leaf-texture", "velvet-anthurium", "app-identify"],
    "lp-papillilaminum.png": ["velvet-anthurium", "rarest-jungle", "app-identify"],
    "lp-carla-blackie.png": ["velvet-anthurium", "leaf-texture", "app-identify"],
}
MOOD_LIB = {
...
SHOWCASE_POSTS = [
    {"branch": "velvet-anthurium", "title": "The Queen, up close", "prefer": CMP+"lp-warocqueanum.png",
    ...
    {"branch": "rainforest-beauty", "title": "Understory", "prefer": PLT+"aroid.jpg",
    ...
    {"branch": "leaf-texture", "title": "Crystalline veins", "prefer": CMP+"lp-crystallinum.png",
    ...
    {"branch": "rarity-value", "title": "More than a phone", "prefer": STK+"anthurium-regale-hero.jpg",
     "caption": "Yes, people pay thousands for a single plant.\n\nA rare velvet anthurium can change hands for the price of a used car. Sounds insane — until you see one in person and watch the room go quiet."},
    {"branch": "collector-culture", "title": "The obsession", "prefer": PLT+"field-skills.jpg",
    ...
    {"branch": "velvet-anthurium", "title": "Ace of Spades", "prefer": CMP+"lp-ace-of-spades.png",
    ...
    {"branch": "rainforest-beauty", "title": "Green wall", "prefer": PLT+"plant-12.jpg",
    ...
    {"branch": "leaf-texture", "title": "Bone-white veins", "prefer": IG+"anthurium-forgetii.png",
    ...
    {"branch": "rarity-value", "title": "Why so rare", "prefer": IG+"anthurium-morona.jpeg",
    ...
    {"branch": "velvet-anthurium", "title": "Velvet up close", "prefer": CMP+"lp-papillilaminum.png",
    ...
    {"branch": "rainforest-beauty", "title": "Morning dew", "prefer": PLT+"plant-06.jpg",
    ...
    {"branch": "leaf-texture", "title": "Quilted & bullate", "prefer": IG+"anthurium-corrugatum.jpeg",
    ...
    {"branch": "rarity-value", "title": "Variegation lottery", "prefer": STK+"anthurium-magnificum-clarinervium-hybrids-hero.jpg",
    ...
    {"branch": "velvet-anthurium", "title": "The bridge", "prefer": IG+"anthurium-cupulispathum.jpeg",
