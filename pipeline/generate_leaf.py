...
def build_prompt(item: dict) -> str:
    return (
        ...
        "photo. The photo is an UNSPECIFIED iNaturalist shot of the subject (often a "
        "wild plant), so describe ONLY what is reliably true of it. Do NOT mention "
        "lighting ('backlit'), pots, moss poles, age, or actions ('unfurling') — you "
